...
import { createNoteAction } from "../forum/noteActions";
...
export const register =
  (userID, userName, password, isAdministrator) =>
...
export const deleteUserAction = (deleteeID) => async (dispatch, getState) => {
  try {
    dispatch({
